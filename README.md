...
Lessons learned: [`docs/lessons/`](docs/lessons/) — 36 lessons across 5 blocks (infrastructure, statistical methods, optimization, validation, web app). View as a browsable web page: serve `docs/lessons/` and open [`lessons.html`](docs/lessons/lessons.html).
