...
CATEGORY_KEYWORDS = {
    "eng": ["engineering", "duckdb", "performance", "pipeline", "migration", "download", "concurrent", "batch",
            "linter", "packaging", "pyarrow"],
    "data": ["data", "population", "disjoint", "surrogate", "null", "feature", "month-fit", "clustering"],
    "stats": ["bayesian", "elo", "borda", "krippendorff", "composite", "chi-squared", "ground-truth",
